...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 10 déc. 2021 à 18:23
...
--
-- Structure de la table `advance_salary`
--
...
--
-- Structure de la table `attachments_type`
--
...
--
-- Structure de la table `bulk_msg_category`
--
...
--
-- Structure de la table `bulk_sms_email`
--
...
--
-- Structure de la table `card_templete`
--
...
--
-- Structure de la table `certificates_templete`
--
...
--
-- Structure de la table `exam_attendance`
--
...
--
-- Structure de la table `exam_hall`
--
...
--
-- Structure de la table `exam_mark_distribution`
--
...
--
-- Structure de la table `exam_term`
--
...
--
-- Structure de la table `fees_reminder`
--
...
--
-- Structure de la table `fees_type`
--
...
--
-- Structure de la table `fee_allocation`
--
...
--
-- Structure de la table `fee_fine`
--
...
--
-- Structure de la table `fee_groups_details`
--
...
--
-- Structure de la table `fee_payment_history`
--
...
--
-- Structure de la table `front_cms_events`
--
...
--
-- Déchargement des données de la table `front_cms_exam_results`
--
...
--
-- Structure de la table `front_cms_gallery`
--
...
--
-- Déchargement des données de la table `front_cms_gallery`
--
...
--
-- Structure de la table `front_cms_gallery_category`
--
...
--
-- Structure de la table `front_cms_gallery_content`
--
...
(1, 'Formations continues', 'uca', 1, 1, 'red', 'disable', '', '', 'Av Abdelkrim Khattabi, B.P. 511 - 40000 -', '(+212) 524 437 741   / (+212) 524 434 814', '(+212) 5 24 43 44 94', 'ucacom@uca.ma', 'ucacom@uca.ma', 'Copyright © 2021 <span>IRISI Student</span>. All Rights Reserved.', 'fav_icon1.png', 'logo1.png', 'CONTACT', '<span>Heures de travail : </span>  Lundi au Vendredi - 8AM - 18PM', 'https://facebook.com', 'https://twitter.com', 'https://youtube.com', 'https://google.com', 'https://linkedin.com', 'https://pinterest.com', 'https://instagram.com', 1);
...
--
-- Structure de la table `hall_allocation`
--
...
--
-- Structure de la table `hostel_category`
--
...
--
-- Structure de la table `hostel_room`
--
...
(472, 'login_deactivate', 'Login Deactivate', 'تسجيل الدخول', 'Login Désactiver'),
...
(4, 'French', 'french', 1, '2018-11-15 11:36:31', '2021-12-02 12:33:30');
...
--
-- Structure de la table `live_class`
--
...
--
-- Structure de la table `live_class_config`
--
...
--
-- Structure de la table `live_class_reports`
--
...
(2, 2, 'faissal.elfid@gmail.com', '$2y$10$jVXTSU3ds83opCul3elgOeP1PdsfNH1s/SagahBxCjpkyBeWh7Uj6', 1, 1, '2021-12-10 16:00:35', '2021-11-04 18:42:34', NULL);
...
INSERT INTO `online_admission` (`id`, `first_name`, `last_name`, `gender`, `birthday`, `mobile_no`, `email`, `address`, `guardian_name`, `guardian_relation`, `father_name`, `mother_name`, `grd_occupation`, `grd_income`, `grd_education`, `grd_email`, `grd_mobile_no`, `grd_address`, `status`, `payment_status`, `payment_amount`, `payment_details`, `branch_id`, `class_id`, `section_id`, `apply_date`, `created_date`) VALUES
(1, 'faissal', 'EL FID', 'male', '1999-11-07', '0682484660', 'faissal.elfid@gmail.com', 'Taza', 'Driss', 'Father', '', '', 'Student', '', '', '', '0600000000', 'Taza', 3, 0, '0.00', '', 1, 1, 1, '2021-11-07 15:51:07', '2021-11-07 14:55:47'),
(2, 'Faissal', 'FID', 'male', '1999-11-16', '0682484660', 'faissal.elfid@gmail.com', 'AV HASSAN 2 IMM 9 NAKHIL APT N 10 TAZA', '', '', '', '', '', '', '', '', '', '', 1, 0, '0.00', '', 1, 2, 10, '2021-11-09 20:35:41', '2021-11-09 19:35:41');
...
--
-- Structure de la table `payment_config`
--
...
--
-- Structure de la table `payment_salary_stipend`
--
...
--
-- Structure de la table `payslip_details`
--
...
('8aujo6v37r82blrjl8nf5sb8i665q7pj', '::1', 1639156944, ),
...
--
-- Structure de la table `salary_template`
--
...
--
-- Structure de la table `salary_template_details`
--
...
--
-- Déchargement des données de la table `sms_api`
--
...
--
-- Structure de la table `sms_credential`
--
...
--
-- Déchargement des données de la table `sms_template`
--
...
--
-- Structure de la table `sms_template_details`
--
...
(2, '5254520', 'Faissal', 0, '', NULL, NULL, 0, '2021-11-04', '', '', '', '', '', '', '', 'faissal.elfid@gmail.com', 0, NULL, NULL, NULL, NULL, NULL, '2021-11-04 18:42:34', NULL);
...
--
-- Structure de la table `staff_bank_account`
--
...
--
-- Structure de la table `staff_department`
--
...
--
-- Structure de la table `staff_documents`
--
...
--
-- Structure de la table `student_category`
--
...
--
-- Déchargement des données de la table `student_category`
--
...
(4, 1, 'Diplôme universitaire médecine.');
...
--
-- Structure de la table `subject_assign`
--
...
--
-- Structure de la table `teacher_allocation`
--
...
--
-- Structure de la table `teacher_note`
--
...
--
-- Structure de la table `timetable_class`
--
...
--
-- Structure de la table `timetable_exam`
--
...
--
-- Structure de la table `transactions_links`
--
...
--
-- Structure de la table `transport_assign`
--
...
--
-- Structure de la table `transport_stoppage`
--
...
--
-- Structure de la table `voucher_head`
--
...
--
-- Structure de la table `zoom_own_api`
--
