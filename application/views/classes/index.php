                            ...
                            <section class="panel panel-custom">
                                ...
                                <div class="panel-body panel-body-custom">
                                    <div class="form-group">
                                        <label class="control-label"><?= translate('name') ?> Niveau <span
                                                    class="required">*</span></label>
                                        <input type="text" class="form-control" name="name" value=""/>
                                        <span class="error"></span>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label"><?= translate('section') ?>s <span class="required">*</span></label>
                                        <?php
                                        $arraySection = array();
                                        $result = $this->db->where('branch_id', 1)->get('section')->result();
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if (get_permission('classes', 'is_edit')): ?>
                                                            <!--update link-->
                                                            <a href="<?php echo base_url('classes/edit/' . $row['id']); ?>"
